...
initP(7,1)=0.0118%0.0115=0.0462*0.5*(5/10) %500.30e-6+15.30e-6
...
% writematrix(MC(:,1),abs_path+'/JEKF-SANTO/Evaluation_with_synthetic_data_specific_P0/MRDE_with_P_uncorrelated/Xv_result_sol_SIC_pu.csv')
% writematrix(MC(:,6),abs_path+'/JEKF-SANTO/Evaluation_with_synthetic_data_specific_P0/MRDE_with_P_uncorrelated/mAb_result_sol_SIC_pu.csv')
% writematrix(MC(:,7),abs_path+'/JEKF-SANTO/Evaluation_with_synthetic_data_specific_P0/MRDE_with_P_uncorrelated/QmAb_result_sol_SIC_pu.csv')
% 
% 
