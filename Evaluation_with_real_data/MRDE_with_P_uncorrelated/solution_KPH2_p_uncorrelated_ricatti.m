...
%     Xv; Glc; Gln; Lac; Amm; AAV; uxv; uglc; ugln; ulac; uamm; kdeg; uaav
   writematrix(MC(:,1),abs_path+'/JEKF-SANTO/Evaluation_with_real_data/MRDE_with_P_uncorrelated/Xv_result_KPH2_pc_rd.csv')
   writematrix(MC(:,2),abs_path+'/JEKF-SANTO/Evaluation_with_real_data/MRDE_with_P_uncorrelated/GLC_result_KPH2_pc.csv')
   writematrix(MC(:,4),abs_path+'/JEKF-SANTO/Evaluation_with_real_data/MRDE_with_P_uncorrelated/LAC_result_KPH2_pc.csv')
   writematrix(MC(:,6),abs_path+'/JEKF-SANTO/Evaluation_with_real_data/MRDE_with_P_uncorrelated/rAAV_result_KPH2_pc.csv')
   writematrix(MC(:,8),abs_path+'/JEKF-SANTO/Evaluation_with_real_data/MRDE_with_P_uncorrelated/uGLC_result_KPH2_pc.csv')
   writematrix(MC(:,10),abs_path+'/JEKF-SANTO/Evaluation_with_real_data/MRDE_with_P_uncorrelated/uLAC_result_KPH2_pc.csv')
   writematrix(MC(:,13),abs_path+'/JEKF-SANTO/Evaluation_with_real_data/MRDE_with_P_uncorrelated/urAAV_result_KPH2_pc.csv')
