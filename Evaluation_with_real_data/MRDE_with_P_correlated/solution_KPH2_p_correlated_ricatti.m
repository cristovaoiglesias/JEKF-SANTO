...
%     Xv; Glc; Gln; Lac; Amm; AAV; uxv; uglc; ugln; ulac; uamm; kdeg; uaav
   writematrix(MC(:,1),abs_path+'/JEKF-SANTO/Evaluation_with_real_data/MRDE_with_P_correlated/Xv_result_KPH2_pc_rd.csv')
   writematrix(MC(:,2),abs_path+'/JEKF-SANTO/Evaluation_with_real_data/MRDE_with_P_correlated/GLC_result_KPH2_pc.csv')
   writematrix(MC(:,4),abs_path+'/JEKF-SANTO/Evaluation_with_real_data/MRDE_with_P_correlated/LAC_result_KPH2_pc.csv')
   writematrix(MC(:,6),abs_path+'/JEKF-SANTO/Evaluation_with_real_data/MRDE_with_P_correlated/rAAV_result_KPH2_pc.csv')
   writematrix(MC(:,8),abs_path+'/JEKF-SANTO/Evaluation_with_real_data/MRDE_with_P_correlated/uGLC_result_KPH2_pc.csv')
   writematrix(MC(:,10),abs_path+'/JEKF-SANTO/Evaluation_with_real_data/MRDE_with_P_correlated/uLAC_result_KPH2_pc.csv')
   writematrix(MC(:,13),abs_path+'/JEKF-SANTO/Evaluation_with_real_data/MRDE_with_P_correlated/urAAV_result_KPH2_pc.csv')
