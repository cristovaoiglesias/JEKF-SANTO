...
% writematrix(MC(:,1),abs_path+'/JEKF-SANTO/Evaluation_with_synthetic_data/MRDE_with_P_correlated/Xv_result_SIC_pc.csv')
% writematrix(MC(:,6),abs_path+'/JEKF-SANTO/Evaluation_with_synthetic_data/MRDE_with_P_correlated/mAb_result_SIC_pc.csv')
% writematrix(MC(:,7),abs_path+'/JEKF-SANTO/Evaluation_with_synthetic_data/MRDE_with_P_correlated/QmAb_result_SIC_pc.csv')
