...
legend('mAb JEKF-KPH2','mAb True','mAb noise True');
xlabel('Time (hours)');
...
% 
% writematrix(MC(:,1),abs_path+'/JEKF-SANTO/Evaluation_with_synthetic_data/MRDE_with_P_correlated/Xv_result_KPH2_pc.csv')
% writematrix(MC(:,6),abs_path+'/JEKF-SANTO/Evaluation_with_synthetic_data/MRDE_with_P_correlated/mAb_result_KPH2_pc.csv')
% writematrix(MC(:,7),abs_path+'/JEKF-SANTO/Evaluation_with_synthetic_data/MRDE_with_P_correlated/QmAb_result_KPH2_pc.csv')
